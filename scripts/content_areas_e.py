...
PAGES.append(dict(
    path="/areas/bavdhan",
    slug="bavdhan",
    title="Interior Designers in Bavdhan, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Bavdhan, Pune",
...
PAGES.append(dict(
    path="/areas/pashan",
    slug="pashan",
    title="Interior Designers in Pashan, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Pashan, Pune",
    service="Pashan, Pune",
...
PAGES.append(dict(
    ...
    slug="erandwane",
    title="Interior Designers in Erandwane, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Erandwane, Pune",
...
PAGES.append(dict(
    ...
    slug="tathawade",
    title="Interior Designers in Tathawade, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Tathawade, Pune",
...
PAGES.append(dict(
    ...
    title="Interior Designers in Magarpatta City, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Magarpatta City, Pune",
