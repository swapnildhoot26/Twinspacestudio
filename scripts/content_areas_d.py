...
PAGES.append(dict(
    ...
    title="Interior Designers in Koregaon Park, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Koregaon Park, Pune",
...
PAGES.append(dict(
    ...
    title="Interior Designers in Viman Nagar, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Viman Nagar, Pune",
...
PAGES.append(dict(
    ...
    title="Interior Designers in Kalyani Nagar, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Kalyani Nagar, Pune",
...
PAGES.append(dict(
    ...
    title="Interior Designers in Mundhwa, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Mundhwa, Pune",
...
PAGES.append(dict(
    ...
    title="Interior Designers in Hadapsar, Pune | Twin Space Studio",
    ...
    h1="Interior Designers in Hadapsar, Pune",
